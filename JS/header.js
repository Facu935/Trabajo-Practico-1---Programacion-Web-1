...
function modalCursosObtenidosEnCarrito(contador, contenedor) {
  contador.addEventListener("click", () => {
    ...
    for (let i = 0; i < cursosEnCarritoDelUsuario.length; i++) {
      ...
      const templateCursos = `<div class="recuadro-curso-sidebar" id="recuadro-sidebar${
        i + 1
      }">
                                                        <h3>${curso.nombre}</h3>
                                                        <div class = "recuadro-curso-sidebar segundo-renglon">
                                                            <ul>
                                                                <li id="precio-curso-carrito">${
                                                                  curso.precio
                                                                }</li>
                                                                <li>(Cantidad)</li>
                                                                <li>(Modalidad)</li>
                                                            </ul>
                                                            <button class="boton-eliminar-curso-carrito" id="boton-eliminar${
                                                              i + 1
...
function mostrarOpcionesUsuarios(contenedor_general) {
  const boton_bienvenido = contenedor_general.querySelector(
