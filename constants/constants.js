...
export const FOOTER_REDES = [
  {
    img: "../IMG/Logo Facebook.png",
    alt: "Facebook",
    href: "https://www.facebook.com/",
  },
  {
    img: "../IMG/Logo Instagram.jpeg",
    alt: "Instagram",
...
export const CURSOS_INFO = [
  ...
  },
  {
    ...
    descripcion:
      "Este curso ofrece una visión completa de la tecnología blockchain, desde los conceptos básicos hasta aplicaciones prácticas. Aprenderás cómo funcionan las criptomonedas, qué es la minería, cómo operan los nodos y cómo crear contratos inteligentes. Se incluyen ejemplos reales y casos de uso de empresas y startups. Los estudiantes desarrollarán un entendimiento profundo de cómo blockchain cambia la forma en que se manejan los datos y las transacciones digitales, y cómo se puede aplicar en distintos sectores.",
  },
  {
    nombre: "Jquery",
  ...
  },
  {
    ...
    requisitos: [
      "Acceso a Internet",
      "Conocimientos sólidos de JavaScript, HTML y CSS",
    ],
    destacado: false,
    cuposDisponibles: 30,
    img: "../IMG/Otros Cursos/logo-react.png",
    descripcion:
      "Este curso cubre React a nivel avanzado, ideal para desarrolladores que quieren crear aplicaciones web interactivas y escalables. Se abordan componentes, hooks, routing, estado global, integración con APIs, testing y optimización de rendimiento. Los proyectos prácticos incluyen desarrollo de dashboards, e-commerce y SPA (Single Page Applications). Cada unidad tiene ejercicios y retos que simulan escenarios reales de trabajo profesional en frontend moderno",
  },
];
